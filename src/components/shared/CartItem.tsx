...
export interface ICartItem {
  variantId: string; // ID único de la variante (color+almacenamiento)
...
export const CartItem = ({ item }: Props) => {
  ...
  //TODO: Add increment and decrement function
  const increment = () => {
  ...
  return (
    <li className="fñex justify-between items-center gap-5">
      <div className="flex">
        <img
          src={item.image}
          alt={item.name}
